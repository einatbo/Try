...
typedef double         FP64;                        /* Double precision floating point                     */
    ...
    #if !defined(__LONG_LONG_MAX__) || (__LONG_LONG_MAX__ == 0xFFFFFFFFUL)
        /*-------------------------------------------------------------------------------------------------*/
        /* long long type is not defined or is 32bit                                                       */
        /*-------------------------------------------------------------------------------------------------*/
        typedef UINT32          UINT64[2];          /* Unsigned 64 bit quantity                            */
        typedef INT32           INT64[2];           /* Signed 64 bit quantity                              */
    #else
        /*-------------------------------------------------------------------------------------------------*/
        /* long long type is defined and it is 64bit                                                       */
        /*-------------------------------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------------------------------------*/
#elif defined (_ARM_) || defined (__arm__) || defined (__arm)
